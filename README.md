...
The `livelike` feedstock is available via the [conda-forge channel](https://github.com/conda-forge/livelike-feedstock).
...
`livelike` is available on the [Python Package Index](https://pypi.org/project/livelike/).
...
* See usage examples in [`./notebooks/`](https://github.com/likeness-pop/livelike/tree/main/notebooks)
