...
# build ``puma`` object through methods
pup = pup.clean_constraints()
pup = pup.build_individual_constraints()
pup = pup.build_tract_input()
pup = pup.build_block_group_input()
pup = pup.validate_columns()
